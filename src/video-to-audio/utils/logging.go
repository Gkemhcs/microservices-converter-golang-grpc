	...
	func NewLogger() *logrus.Logger {
		...
		if isDocker {
			...
			logFile, err := os.OpenFile(os.Getenv("LOG_DIR")+"/video-to-audio.log", os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0666)
			if err != nil {
		...
		return logger.WithField("service", "video-to-audio-converter").Logger
	}
